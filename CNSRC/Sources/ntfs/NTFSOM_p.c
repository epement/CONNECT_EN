...
/* Object interface: IFileObject, ver. 0.0,
   GUID={0x0BFCA612,0x0820,0x4645,{0xB1,0xF6,0x20,0x2A,0x5F,0x5C,0x49,0xAB}} */
...
CINTERFACE_PROXY_VTABLE(21) _IFileObjectProxyVtbl = 
{
    &IFileObject_ProxyInfo,
    &IID_IFileObject,
    ...
    (void *)-1 /* IFileObject::get_Compressed */ ,
    (void *)-1 /* IFileObject::put_Compressed */ ,
    (void *)-1 /* IFileObject::SetFile */ ,
    (void *)-1 /* IFileObject::get_Encrypted */ ,
    (void *)-1 /* IFileObject::put_Encrypted */ ,
    (void *)-1 /* IFileObject::get_EncryptionStatus */ ,
    (void *)-1 /* IFileObject::get_CompressedSize */ ,
    (void *)-1 /* IFileObject::get_Size */ ,
    (void *)-1 /* IFileObject::MakeSparse */ ,
    (void *)-1 /* IFileObject::get_Sparse */ ,
    (void *)-1 /* IFileObject::Zero */ ,
    (void *)-1 /* IFileObject::Test */ ,
    (void *)-1 /* IFileObject::MountVolume */ ,
    (void *)-1 /* IFileObject::DeleteMountVolume */
};
...
/* 138 */	0x8,		/* FC_LONG */
	...
	/* Procedure get_EncryptionStatus */
...
const CInterfaceProxyVtbl * _NTFSOM_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IFileObjectProxyVtbl,
    0
};

const CInterfaceStubVtbl * _NTFSOM_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IFileObjectStubVtbl,
    0
};

PCInterfaceName const _NTFSOM_InterfaceNamesList[] = 
{
    "IFileObject",
    0
};

const IID *  _NTFSOM_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _NTFSOM_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _NTFSOM, pIID, n)

int __stdcall _NTFSOM_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_NTFSOM_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo NTFSOM_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _NTFSOM_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _NTFSOM_StubVtblList,
    (const PCInterfaceName * ) & _NTFSOM_InterfaceNamesList,
    (const IID ** ) & _NTFSOM_BaseIIDList,
    & _NTFSOM_IID_Lookup, 
    1,
    2,
