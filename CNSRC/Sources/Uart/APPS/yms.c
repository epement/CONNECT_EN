//
// NAME: YMS.C [YMODEM Send]
//
// TYPE: Win32 console mode.
//
// DATE: August 12, 2004.
//
// PURPOSE: YMODEM (send) example program.
//
// NOTE:    Requires XYM [ver 3.1 or above]
//
// COMPILE: From the command line:
//
//     nmake -f yms32._m_  (Microsoft VC)
//      make -f yms32._b_  (Borland 5.0)
//      make -f yms32._i_  (Borland 5.5)
//     wmake -f yms32._w_  (Watcom 11)
//
...
{int Code;
 ...
 printf("YMS Example Program\n");
 if(argc != 4)
   {printf("Usage: YMS <port> <baud> <filename>\n");
    printf("   Eg: YMS 1 38400 myfile.dat\n");
    // how to send multiple files
    printf("   Eg: YMS 2 57600 %cfile1.bin,file2.bin%c\n",QUOTE,QUOTE);
    exit(1);
   }
 // get parameters
 Port = atoi(argv[1]) - 1;
 ...
 printf("Starting YMODEM send (type Control-BREAK to quit)\n");
 xyStartTx(Port, FileName, ONE_K, YMODEM);
