...
NoMangle int DLL_IMPORT_EXPORT SioKeyCode(unsigned long);
NoMangle int DLL_IMPORT_EXPORT SioGetc(int);
NoMangle int DLL_IMPORT_EXPORT SioGetReg(LPSTR,int);
...
NoMangle int DLL_IMPORT_EXPORT SioSetInteger(int, int, LONG);
#endif
