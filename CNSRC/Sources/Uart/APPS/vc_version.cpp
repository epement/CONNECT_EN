                       ...
                       int       nCmdShow)
{
        ...
        LoadString(hInstance, IDC_VC_VERSION, szWindowClass, MAX_LOADSTRING);
        ...
        hAccelTable = LoadAccelerators(hInstance, (LPCTSTR)IDC_VC_VERSION);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
        ...
        wcex.hIcon              = LoadIcon(hInstance, (LPCTSTR)IDI_VC_VERSION);
        wcex.hCursor            = LoadCursor(NULL, IDC_ARROW);
        wcex.hbrBackground      = (HBRUSH)(COLOR_WINDOW+1);
        wcex.lpszMenuName       = (LPCTSTR)IDC_VC_VERSION;
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
                ...
                switch (wmId)
                {
                 case MSG_INFO:
                   {int Version;
                    ...
                    DisplayString(hWnd, (LPSTR)Temp, 1);
                    // display registration string
                    Code = SioGetReg((LPSTR)Temp, 50);
                    if(Code>0) DisplayString(hWnd, (LPSTR)Temp, 2);
                    ...
                    DisplayString(hWnd, (LPSTR)Temp, 3);
                   }
                   break;
        ...
        case WM_CREATE:
                ...
                // char Temp[80];
                // Code = SioKeyCode(0);
                // wsprintf((LPSTR)Temp,"SioKeyCode(0) returns %d",Code);
                // MsgBox((LPSTR)Temp);
                //}
                break;
