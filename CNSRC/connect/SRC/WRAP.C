 ...
 * ‘«®Ά  ―®αβγ― ξβ α® αβ ­¤ ΰβ­®£® ΆΆ®¤ 
 *
 * €Άβ®ΰ: €­¤ΰ¥© ‹¥Ά®ηª¨­ (andrew@sinor.nsk.su)
 */
...
extern pascal int wh[255];    /* “ª § β¥«¨ ­  ―¥ΰ¥­®α¨¬λ¥ α¨¬Ά®«λ */
static char cp1[100];
...
extern pascal near wrap()
{
...

        {
                ...
                wh[j+1] = 0;    /* ‚β®ΰ®© α¨¬Ά®« Ά R */
                wh[lword-1] = 0;        /* ®α«¥¤­¨© α¨¬Ά®« Ά R */
                wh[j-1] = 0;    /* ®α«¥¤­¨© α¨¬Ά®« Ά ―®α«¥¤­¥© ªΆ §¨―ΰ¨αβ Άª¥ */
                wh[j - hp[hpp-1] + 1] = 0; /* ‚β®ΰ®© α¨¬Ά®« Ά ―®α«¥¤­¥© ªΆ §¨―ΰ¨αβ Άª¥ */
                j = 0;
                for(i=0; i<hpp; i++){   /* –¨ª« ―® ªΆ §¨―ΰ¨αβ Άª ¬ */
...
char c;
{
        ...
        case ''&0xff: case '¨'&0xff:                   /*     */
        case ''&0xff: case '®'&0xff:                   /*     */
        case '“'&0xff: case 'γ'&0xff:                   /*  “   */
        case '›'&0xff: case 'λ'&0xff:                   /*  ›   */
        case ''&0xff: case 'ν'&0xff:                   /*     */
        case ''&0xff: case 'ξ'&0xff:                   /*     */
        case ''&0xff: case 'ο'&0xff:   return(1);      /*     */
...
unsigned char c;
{
        switch(c&0377) {
               case '‰'&0xff: case '©'&0xff:
               case ''&0xff: case 'μ'&0xff:
               case 'κ'&0xff: case ''&0xff:
               return(1);
        default: return(0);
        }
}
...
=======================================
   ...
   † «μ, Ά timEd'¥ § ¬¥­λ ­¥β, β ª ηβ® α ¬ α β ΅γ«οζ¨ο¬¨ Ά ­ η «¥ p §΅¨p ©αο ;)
